...
export default class TestService extends Service {
  ...
  getResultByUserCode(userCode: string): Observable<ResultRetrievalDTO | null> {
    return this.httpClient
      .get<ApiResponse<ResultRetrievalDTO>>(
        `${this.baseURL}/${userCode}/result`
      )
      .pipe(map((response) => response.data));
  }
  ...
  ): Observable<TestRetrievalDTO | null> {
    return this.httpClient
  ...
  saveStatement(
    ...
    return this.httpClient
      .patch<ApiResponse<TestRetrievalDTO>>(
        `${this.baseURL}/${userCode}/statements`,
        testStatementSavingDTO
      )
      .pipe(map((response) => response.data));
  }
  ...
  findPersonalities(
    userCode: string
  ): Observable<PersonalityRetrievalDTO[] | null> {
    return this.httpClient
      .get<ApiResponse<PersonalityRetrievalDTO[]>>(
        `${this.baseURL}/${userCode}/personalities`
      )
      .pipe(map((response) => response.data));
  }
  ...
  findPersonality(
    ...
    return this.httpClient
      .get<ApiResponse<TestRetrievalDTO>>(
        `${this.baseURL}/${userCode}/personalities/${personalityLetter}`
      )
      .pipe(map((response) => response.data));
  }
